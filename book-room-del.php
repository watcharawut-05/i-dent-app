    ...
    <div class="row">
        <div class="col-md-12">
          <div class="box box-danger">
            ...
            <div class="box-body">
            <form action="qry/book_room_del.php?mid=<?=$mid?>" method="post">
                    <div class="modal-body">
                        <h4><mark class="bg-info text-light">ลบ ข้อมูลการจองห้องประชุม <?=$room_name;?></mark> </h4>
                      ...
                      <h4><mark class="bg-danger text-light">อุปกรณ์</mark> </h4>
                        <div class="form-row bg-ker py-4">
                            ...
                            <div class="col-md-2 offset-1 px-3 pt-2">
                                ...
                                <label class="custom-control-label" for="label">ป้าย</label>
                            </div>
                            <div class="col-md-10">
...
;?>
                ...
                <div class="form-row">
					<button type="submit" class="btn btn-danger pull-left">ลบ</button>
