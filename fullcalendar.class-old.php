...
class Fullcalendar {
    ...
    private $password = 'dhdcdb10978';
    // password สำหรับเข้าจัดการฐานข้อมูล
    private $database = 'hios';
    //ชื่อ ฐานข้อมูล
    ...
    public function get_fullcalendar() {
        ...
        $db = $this->connect();
        $get_calendar = $db->query( "SELECT m.meeting_id,CONCAT(SUBSTR(m.stime,1,5),' ',m.topic) AS topic,m.sdate,m.edate,r.room_name,room_color 
        FROM mav_meeting m
