...
$sql = "UPDATE mav_meeting_room SET room_name=:room_name,room_value=:room_value,
room_place=:room_place,room_detail=:room_detail,room_note=:room_note,
room_color=:room_color,room_keeper=:room_keeper,room_status=:room_status
