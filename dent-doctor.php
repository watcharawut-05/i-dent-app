...
?>
		...
		<div class="col-lg-3">
		<div>
		<a class="btn btn-success" data-toggle="modal" data-target="#room_add" data-backdrop="static">เพิ่มชื่อหมอ</a>
		...
		<h3 class="box-title">รายการห้องประชุม ของ :  <?php echo $head; ?>	</h3>
		</div>
		<!-- /.box-header -->
		<div class="box-body">
