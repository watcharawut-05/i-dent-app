...
<div class="wrapper">
  ...
  <section class="content">
    ...
    <h3 align="center">คลิกเลือกห้องประชุมที่ต้องการจอง</h3>             
      ...
      <div class="col-md-3">
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title"><?=$room_name?></h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <a href="book-room-add.php?room_id=<?=$room_id;?>"><img src="room_pic/<?=$room_pic;?>" class="img-rounded" width="100%"></a>
              <div class="box-footer"><?=$room_place;?>  <?=$room_value?> คน</div>
				    </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
