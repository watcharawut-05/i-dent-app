    ...
    <div class="row">
        <div class="col-md-12">
          <div class="box box-danger">
            ...
            <div class="box-body">
            <form action="qry/book_room_approve.php?mid=<?=$mid?>" method="post">
                    <div class="modal-body">
                        <h4><mark class="bg-info text-light">อนุมัติการจอง</mark> </h4>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="time" class="form-control" id="stime" name="stime" value="<?php echo $stime;?>" required>
                        </div>
                        <div class="form-group col-md-3">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="time" class="form-control" id="etime" name="etime" value="<?php echo $etime;?>" required>
                        </div>

                        <div class="form-group col-md-3">
                            <label for="rooms" class="control-label">ห้องประชุม</label>
							<select class="form-control select2" style="width: 100%;" id="rooms" name="rooms" data-validation="required">
								<?php
...
;?>
                      ...
                      <h4><mark class="bg-danger text-light">อุปกรณ์</mark> </h4>
                        <div class="form-row bg-ker py-4">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="label_text" name="label_text" value="<?php echo $label_text; ?>">
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="approve_user" value="<?php print $sess_fullname;?>"/>
                    </div>
                    <div class="form-group col-md-2">
                        <label for="meeting_status">สถานะ</label>
                        <select class="form-control select2" id="meeting_status" name="meeting_status" data-validation="required">
                          <?php
                            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                            ...
                            ?>
                          <option value="<?php echo $status_id; ?>" <?php if ($meeting_status == $status_id) {echo " selected ";}?>><?php echo $status_name; ?></option>
                          <?php };?>
					    </select>
                    </div>
            </div>
                <div class="form-row">
					<button type="submit" class="btn btn-primary pull-left">อนุมัติ</button>
