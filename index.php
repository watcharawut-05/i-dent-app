...
<div class="wrapper">
    ...
    <section class="content">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-aqua">
            ...
            ?>
              <span class="info-box-text"><b>จำนวนการนัด ปีนี้</b></span>
              <div class="progress">
        ...
        while($rs=$query->fetch(PDO::FETCH_ASSOC)){
				...
				?>
              <span class="info-box-text"><b>จำนวนการนัด เดือนนี้</b></span>
              <div class="progress">
                <div class="progress-bar" style="width: 100%"></div>
              </div>
        ...
        $pt=$st*100/$yt;
				...
				?>
              <span class="info-box-text"><b>ร้อยละการมาตามนัด</b></span>
              <div class="progress">
                <div class="progress-bar" style="width: 100%"></div>
              </div>
  ...
  <div class="box box-primary box-solid">
              ...
              <h3 class="box-title">รายการนัดทันตกรรมถัดจากวันนี้</h3>
    ...
    <div class = 'box-header with-border'>
    <h3 class = 'box-title'>กราฟแสดงจำนวนรายการนัด แยกรายเดือน</h3>
    ...
    <div class = 'box-header with-border'>
    <h3 class = 'box-title'>กราฟแสดงรายการนัด แยกประเภท</h3>
